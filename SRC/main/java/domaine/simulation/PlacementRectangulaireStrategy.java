...
public class PlacementRectangulaireStrategy implements PlacementStrategy {
    ...
    public List<ZoneBloc.BlocPlace> simuler(ZoneBloc zone) {
        ...
        return SimulateurPlacement.simulerZoneRectangulaire(largeurPouces, hauteurPouces);
    }
}